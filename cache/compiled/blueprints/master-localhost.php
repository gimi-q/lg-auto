...
return [
    ...
    'timestamp' => 1486931416,
    'checksum' => 'bb2d2ef84fb293ee59aa78cb0b59dd0a',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/adminstyles' => [
                'file' => 'user/plugins/adminstyles/blueprints.yaml',
                'modified' => 1486931266
            ],
            'plugins/email' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.adminstyles.enabled' => [
                ...
                'name' => 'plugins.adminstyles.enabled',
                'validation' => 'loose'
            ],
            'plugins.adminstyles.preview' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.adminstyles.preview',
                'validation' => 'loose'
            ],
            'plugins.adminstyles.current' => [
                'type' => 'radioimage',
                'classes' => 'fancy',
                'name' => 'plugins.adminstyles.current',
                'style' => 'vertical',
                'default' => 'grav_admin',
                'options' => [
                    'grav_admin' => 'Default',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'adminstyles' => [
                    'enabled' => 'plugins.adminstyles.enabled',
                    'preview' => 'plugins.adminstyles.preview',
                    'header' => 'plugins.adminstyles.header',
                    'current' => 'plugins.adminstyles.current'
                ],
                'email' => [
